from src.touchstone import *
from src.power import *
from src.double_stub import *
...
print('Gamma SM', Gamma_S_polar)
print('Gamma LM', Gamma_L_polar)

# print('Gain max method 1', GT_db_1)
# print('Gain max method 2', GT_db_2)

print('RDA Gamma S', Gamma_S_polar)
print('RDA Gamma L', Gamma_L_polar)
